...
export default function RDAAnnotator() {
  ...
  const onDownload = () => {
    ...
    link.href =
      "https://github.com/DANS-KNAW/rda-annotator/releases/download/0.13.0_sandbox/rda-annotator-sandbox_0.13.0.zip";
    link.download = "rda-annotator-sandbox_0.13.0.zip";
    link.click();
  };
