...
const page: Page = {
  ...
  content: {
    ...
    nl: `<p>This dynamic form enables researchers to effortlessly deposit their software repositories along with related datasets for archiving. The source code and their relevant metadata is submitted to Software Heritage for archiving, while the dataset(files) and their metadata are archived in a Dataverse instance. This ensures long-term accessibility and compliance with  FAIR principles.
    <br /> <br />
