...
import { SiteTitleProvider } from '@dans-framework/utils';

export const ThemeWrapper = ({theme, siteTitle, children}: {theme: Partial<Theme>, siteTitle: string, children: ReactNode}) => {
